...
public interface UserItemService {
	...
	/* Equip Item All*/
	UserCharEquipItemPacket equipItemAll(int user_account, int char_id, int user_char_sn, String item_uniqueID_Ary, int item_category, int item_type) throws Exception;
