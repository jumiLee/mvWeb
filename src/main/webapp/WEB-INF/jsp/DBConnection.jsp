...
String DB_url = "jdbc:mysql://edeninstance1.c7wuixzb8pzz.ap-southeast-1.rds.amazonaws.com:3306/nb";	//Amazon Global Live (MYSQL / 노블리스)	
String DB_url_replica = "jdbc:mysql://nbreplica.c7wuixzb8pzz.ap-southeast-1.rds.amazonaws.com:3306/nb";	//Amazon Live Replica (MYSQL / 노블리스)
